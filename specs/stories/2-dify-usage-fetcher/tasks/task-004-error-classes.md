...
## 対象ファイル
- [x] `src/errors/dify-api-error.ts` - カスタムエラークラス定義
- [x] `test/unit/errors/dify-api-error.test.ts` - エラークラステスト

## 実装手順（TDD: Red-Green-Refactor）

### 1. Red Phase
- [x] `test/unit/errors/dify-api-error.test.ts` を作成
...
### 2. Green Phase
- [x] `src/errors/` ディレクトリを作成
- [x] `src/errors/dify-api-error.ts` を作成
  ```typescript
